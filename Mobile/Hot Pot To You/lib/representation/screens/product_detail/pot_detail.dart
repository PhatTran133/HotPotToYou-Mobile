...
class PotDetail extends StatefulWidget {
  ...
  static const String routeName = '/pot_detail';
  @override
  State<PotDetail> createState() => _PotDetailState();
}

class _PotDetailState extends State<PotDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final PotModel potModel = widget.potModel;
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    AspectRatio(
                      aspectRatio: 13 / 9,
                      child: Image.network(widget.potModel.Url,
                          fit: BoxFit.cover),
                    ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  ' ${NumberFormat.currency(locale: 'vi_VN', symbol: 'vnđ').format(potModel.Price)}',
                                ),
                              ),
                            ],
                          ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 12),
                                child: Text(
                                  ' ${NumberFormat.currency(locale: 'vi_VN', symbol: 'vnđ').format(potModel.Price * quantityUserWantBy)}',
                                ),
                              ),
                            ],
                          ),
                                      ...
                                      onTap: () {
                                        if (authProvider.isLoggedIn) {
                                          ...
                                          if (cartProvider.cartHotPotItems.isEmpty) {
                                            ...
                                            cartProvider.addQuantityPotInCart(
                                                potModel, quantityUserWantBy);
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(
                                              const SnackBar(
