...
class UtensilCard extends StatefulWidget {
  final UtensilModel product;
  ...
  @override
  State<UtensilCard> createState() => _ProductCardState();
}

class _ProductCardState extends State<UtensilCard> {
